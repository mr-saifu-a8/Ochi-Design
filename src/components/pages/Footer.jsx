...
const Footer = () => {
  return (
    <div
      ...
      className="w-full bg-[#F1F1F1] max-h-[105vh] px-15 flex py-30 "
    >
      <div className="w-[50%] flex flex-col justify-between h-[90vh]">
        <div>
          <h1 className="text-[9vw] font-[founders] uppercase leading-[7vw]">
            eye- <br /> opening
          </h1>
          <h1></h1>
        </div>
      ...
      <div className="w-[50%] ">
        <div>
          <h1 className="text-[9vw] font-[founders] uppercase leading-[7.5vw]">
            presentations
          </h1>
        </div>
        <div>
          <h1 className="pt-10 text-xl">S: </h1>
          <ul className="underline text-lg pt-5 pb-10">
            <li>Instagram</li>
            <li>Behance</li>
            <li>Facebook</li>
            <li>LinkedIn</li>
        ...
        <div className="flex justify-between">
          <div>
            <ul className="underline text-lg pt-5 pb-10">
              ...
              <li className="pb-7">Vancouver, Canada</li>
