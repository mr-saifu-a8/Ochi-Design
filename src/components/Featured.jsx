...
const Featured = () => {
  return (
    <div className="w-full bg-[#F1F1F1] font-[neue] pt-15">
      ...
      <div className="px-15 relative py-5 flex gap-3">
        <button className="border rounded-full py-1 px-3 uppercase text-md">
          brand identity
        </button>
        <button className="border rounded-full py-1 px-3 uppercase text-md">
          pitch deck
        ...
        <div className="absolute right-[31vw] flex gap-3">
          <button className="border rounded-full py-1 px-3 uppercase text-md">
            brand identity
          </button>
          <button className="border rounded-full py-1 px-3 uppercase text-md">
